...
{
    /// <summary>
    /// Adapter de Entidades Editable con vista basica
    /// </summary>
    ...
    public abstract class FullEditAdapterBase<VM, E, LIVM, LIE, BIVM, BIE, LCVM, LCE, BCVM, BCE, L> : EditAdapterBase<VM, E, LIVM, LIE, LCVM, LCE, L>, IFullEditAdapter<VM, LIVM, BIVM, LCVM, BCVM>
        ...
        where L : IFullEditLogic<E, LIE, BIE, LCE, BCE>
    {
        #region Methods
        ...
        /// <returns></returns>
        public IListModel<BIVM> GetBasic(BCVM entity)
        {
