...
{
    /// <summary>
    /// Api de Entidades Editable con vista basica
    /// </summary>
    ...
    public abstract class FullEditWebApiControllerBase<VM, LIVM, BIVM, LCVM, BCVM, A> : EditWebApiControllerBase<VM, LIVM, LCVM, A>
        ...
        where A : IFullEditAdapter<VM, LIVM, BIVM, LCVM, BCVM>
    {
        #region Methods
    ...
    /// <typeparam name="BCVM"></typeparam>
    /// <typeparam name="A"></typeparam>
    public abstract class FullEditWebApiControllerBase<VM, LIVM, LCVM, A> : EditWebApiControllerBase<VM, LIVM, LCVM, A>
        where VM : class, ISpecificModel
        where LIVM : class, IListedItemModel
        where LCVM : class, IListedCriteriaModel
        where A : IFullEditAdapter<VM, LIVM, BasicModel, LCVM, BasicCriteriaModel>
    {
    }
}